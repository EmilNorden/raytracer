...
pub fn create_material(material: &gltf::Material, folder: &Path) -> anyhow::Result<Material> {
    ...
    Ok(Material::new(Vector3::new(base_color[0], base_color[1], base_color[2]), albedo_texture, emissive_texture, emissive, roughness, metallic, transmission_factor, ior))
}